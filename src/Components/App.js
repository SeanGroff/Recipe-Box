...
import closeModal from '../Actions/actionCloseModal'
import openModal from '../Actions/actionOpenModal'
...
const mapDispatchToProps = (dispatch) => {
  ...
  return bindActionCreators({ addRecipe, removeRecipe, closeModal, openModal }, dispatch)
}
